...
5.I moved to frontend code path and performed manual deployment without using dockerfile
  ...
  npm -v
  nodejs -v
6.added 3000 port number in security groups along with 80 port as well
7.accessed the url with public ip and portnumber 3000
8.removed the conatiner and image using below commands
  docker stop containerid
  docker rm containerid
  docker rmi imageid
  
#deployment using dockerfile
9.before using dokerfile i have deleted modules to avoid overwritten
10.proceeded with below commands
...
11.addeed hostport 4000 in ec2 security groups
12.accessed the url with public ip and portnumber 4000 successfully
13.pushed to dockerhub using below commands
